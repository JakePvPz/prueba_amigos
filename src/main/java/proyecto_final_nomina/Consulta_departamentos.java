 ...
 */
public class Consulta_departamentos extends javax.swing.JFrame {

    /**
     * Creates new form Consulta_departamentos
     */
    
    DefaultTableModel Tabla;
    
    public Consulta_departamentos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta Departamentos");
    ...
    private void btn_consultarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_consultarMouseClicked
        ...
        File arch = new File("archivos/departamentos.txt");
        ...
        try {
            ...
            if(arch.exists()){
                ...
                while(a.hasNextLine()){
                    ...
                    Tabla.addRow(new Object [] {id, descripcion});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consulta_departamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
