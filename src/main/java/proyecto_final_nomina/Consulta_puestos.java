...
public class Consulta_puestos extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Consulta_puestos
     */
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        File arch = new File("archivos/puestos.txt");
        ...
        try {
            ...
            if(arch.exists()){
                ...
                while(a.hasNextLine()){
                    ...
                    Tabla.addRow(new Object [] {id, nombre});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consulta_puestos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
