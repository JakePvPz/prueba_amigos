 ...
 */
public class Consulta_nomina extends javax.swing.JFrame {

    /**
     * Creates new form Consulta_nomina
     */
    
    DefaultTableModel Tabla;
    
    public Consulta_nomina() {
        initComponents();
    ...
    private void initComponents() {
        ...
        JTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "ID Empleado", "Fecha Nomina", "Salario en bruto", "AFP", "ARS", "Coop", "ISR", "Sueldo Neto", "Status Nomina"
            }
        ) {
    ...
    private void btn_consultarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_consultarMouseClicked
        ...
        File arch = new File("archivos/nomina.txt");
        ...
        try {
            ...
            if(arch.exists()){
                ...
                while(a.hasNextLine()){
                    ...
                    Tabla.addRow(new Object [] {id_nomina, id_nomina, fecha, salario_bruto, valor_afp, valor_ars, valor_coop, valor_isr, sueldo_neto, status});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consulta_nomina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
